...
def link_best_model(sweep_id: str, entity: str = None, project: str = None, target_registry: str = "Model_registry", target_collection: str = "sentiment_analysis_models"):
    """
    ...
    print(f"Metric ({sweep.config.get('metric', {}).get('name')}): {best_run.summary.get(sweep.config['metric']['name'])}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sweep-id", type=str, required=True, help="WandB Sweep ID (entity/project/sweep_id or just sweep_id)")
