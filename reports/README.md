...
We automated this process with a CI/CD pipeline using **GitHub Actions** (as specified in the `.github/workflows/gcp.yaml` file). When code is merged into the `release` branch, our workflow:
